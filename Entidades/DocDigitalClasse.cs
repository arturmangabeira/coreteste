...
namespace IntegradorIdea.Entidades.DocDigitalClasse
{
    /// <remarks/>
    ...
    public partial class Documentos : EntidadeBase
    {

        private DocumentosDocumento[] documentoField;

        private Signature signatureField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Documento")]
        public DocumentosDocumento[] Documento
        {
            get
            {
