...
namespace IntegradorIdea.Entidades.ObterNumeroUnificadoDoProcesso
{
    /// <remarks/>
    ...
    public partial class Processo : EntidadeBase
    {

        private ulong outroNumeroField;

        private string numeroUnificadoField;

        private Signature signatureField;

        /// <remarks/>
        public ulong OutroNumero
        {
            get
            {
                return this.outroNumeroField;
            }
            set
            {
                this.outroNumeroField = value;
            }
        }

        /// <remarks/>
        public string NumeroUnificado
        {
            get
            {
                return this.numeroUnificadoField;
            }
            set
            {
                this.numeroUnificadoField = value;
            }
        }
