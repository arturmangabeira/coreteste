...
// 
namespace IntegradorIdea.Entidades.TipoDiversasClasse
{
    ...
    public partial class Tipos : EntidadeBase
    {

        private TiposTipo[] tipoField;

        private Signature signatureField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Tipo")]
        public TiposTipo[] Tipo
        {
            get
            {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class TiposTipo
    {
